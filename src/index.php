...
<body>
  <header id="top-header">
    ...
    <nav class="header-nav-item-icon">
      ...
      <a href="./pages/login.php"><i class="fa-sharp fa-solid fa-circle-user header-user-icon"></i></a>
    </nav>
  </header>
  <div class="container">
    <aside class="left-nav">
      <div class="icons">
        <a href="#"><i class="fa-solid fa-bars lef-nav-menue-bar-i"><span class="icon-des display-none">Menu</span></i></a>
